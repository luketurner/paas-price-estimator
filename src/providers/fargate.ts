...
export const priceSpec: PricingTableSpec = {
  ...
  container: [
    { 
      ...
      cost: (v) => ({ period: 'hr', rate: 0.04048 * v.cpu + 0.004445 * (v.memory / 1024) }),
    },
    { 
      cpu: 0.5,
      cpuType: 'shared',
      memory: { min: 1024, max: 4 * 1024, step: 1024 },
      name: (v) => `${v.cpu}-cpu ${v.memory / 1024}gb`,
      cost: (v) => ({ period: 'hr', rate: 0.04048 * v.cpu + 0.004445 * (v.memory / 1024) }),
    },
    { 
      cpu: 1,
      cpuType: 'dedicated',
      memory: { min: 2 * 1024, max: 8 * 1024, step: 1024 },
      name: (v) => `${v.cpu}-cpu ${v.memory / 1024}gb`,
      cost: (v) => ({ period: 'hr', rate: 0.04048 * v.cpu + 0.004445 * (v.memory / 1024) }),
    },
    { 
      cpu: 2,
      cpuType: 'dedicated',
      memory: { min: 4 * 1024, max: 16 * 1024, step: 1024 },
      name: (v) => `${v.cpu}-cpu ${v.memory / 1024}gb`,
      cost: (v) => ({ period: 'hr', rate: 0.04048 * v.cpu + 0.004445 * (v.memory / 1024) }),
    },
    { 
      cpu: 4,
      cpuType: 'dedicated',
      memory: { min: 8 * 1024, max: 30 * 1024, step: 1024 },
      name: (v) => `${v.cpu}-cpu ${v.memory / 1024}gb`,
      cost: (v) => ({ period: 'hr', rate: 0.04048 * v.cpu + 0.004445 * (v.memory / 1024) }),
    },
    { 
      cpu: 8,
      cpuType: 'dedicated',
      memory: { min: 16 * 1024, max: 60 * 1024, step: 4 * 1024 },
      name: (v) => `${v.cpu}-cpu ${v.memory / 1024}gb`,
      cost: (v) => ({ period: 'hr', rate: 0.04048 * v.cpu + 0.004445 * (v.memory / 1024) }),
    },
    { 
      cpu: 16,
      cpuType: 'dedicated',
      memory: { min: 32 * 1024, max: 120 * 1024, step: 8 * 1024 },
      name: (v) => `${v.cpu}-cpu ${v.memory / 1024}gb`,
      cost: (v) => ({ period: 'hr', rate: 0.04048 * v.cpu + 0.004445 * (v.memory / 1024) }),
    },
  ],
