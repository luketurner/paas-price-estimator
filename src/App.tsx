...
export const App: Component = () => {
  ...
  const [page, setPage] = createSignal<'main' | 'about' | 'tables'>('main');
    ...
    <AppDBProvider>
      <div class="container mx-auto px-4 max-w-xl border-t-8 border-t-slate-400">
        ...
        <div class="text-center">
          ...
          <button disabled={page() === 'tables'} classList={{'text-slate-500': page() === 'tables'}} onClick={() => setPage('tables')}>tables</button> / 
