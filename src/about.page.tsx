...
import { P, Heading, TocLink } from "./util";
...
export const Page = () => (
  <PageLayout page="about">
    <div class="my-2 text-slate-700">
      ...
      <P>
        The page you're looking at right now is like a combination help/manual/FAQ. 
        You can use the table of contents below to navigate:
      </P>
      ...
      <P>
        For detailed information on free tiers for each provider, visit the <code>tables</code> page.
      </P>
